...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RAMDOM(1,"com.vela.im.shared.route.algorithm.random.RandomHandle"),


    /**
     * 轮询
     */
    LOOP(2,"com.vela.im.shared.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3,"com.vela.im.shared.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
